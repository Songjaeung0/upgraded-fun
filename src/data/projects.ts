...
export const projects: Project[] = [
  {
    ...
    category: 'Frontend',
    role: '퍼블리싱 / JavaScript 구현 / 인터랙션 효과 추가',
    contribution: '디자인은 협업 시안을 기반으로 작업했으며, HTML/CSS/JavaScript 구현과 화면 전환 및 효과 요소를 담당했습니다.',
    ...
    solution: '핵심 메시지와 참여 수치를 상단에 배치해 신뢰와 긴급성을 먼저 전달했습니다. 이후 설명문, 개인정보 동의, 입력 영역을 단계적으로 배치하고 JavaScript 기반 입력 흐름과 시각 효과를 적용해 참여 과정이 끊기지 않도록 구현했습니다.',
    result: '캠페인 홍보와 서명 참여 기능이 한 화면 안에서 이어지는 운영형 랜딩 페이지로 완성했습니다. 협업 시안을 실제 웹 환경에 맞게 구현하고, 필요한 효과를 추가해 사용자가 목적을 이해한 뒤 바로 행동할 수 있는 구조를 만드는 데 집중했습니다.'
  },
  {
    ...
    category: 'Frontend',
    role: '입력 흐름 디자인 / 퍼블리싱 / JavaScript 구현',
    contribution: '팝업 이미지와 최상단 비주얼을 제외한 입력 영역, 신청 흐름, 화면 구성과 구현을 담당했습니다.',
    tools: ['HTML', 'CSS', 'JavaScript', 'Photoshop'],
    ...
    result: '행사 안내와 추천 접수 흐름을 한 페이지 안에서 이해할 수 있도록 정리했습니다. 입력 영역과 신청 흐름을 직접 설계하고 구현해 정보 전달에서 실제 신청 행동까지 이어질 수 있는 구조로 제작했습니다.'
  },
  {
    ...
    category: 'Frontend',
    role: '부분 UI 디자인 / 웹 콘텐츠 구현',
    contribution: '내부 화면 디자인의 약 30%를 담당했으며, HTML/CSS/JavaScript 기반 구현은 전체를 담당했습니다.',
    ...
    result: '다수의 작가 정보를 정리하면서도 작품 소개 영역의 집중도를 유지한 전시형 페이지로 완성했습니다. 일부 UI 디자인에 참여하고 구현 전반을 맡아 단순 홍보물이 아니라 탐색 가능한 웹 콘텐츠로 구성했습니다.'
  },
  {
    ...
    contribution: '전체 디자인, 화면 구성, HTML/CSS/JavaScript 구현을 담당했습니다.',
    ...
    result: '정적인 정보 안내가 아니라 인물과 음악을 함께 기억할 수 있는 추모 콘텐츠형 페이지로 완성했습니다. 디자인부터 구현까지 전 과정을 담당해 감성적인 톤과 웹 화면 구성을 함께 고려한 작업입니다.'
  },
  {
    ...
    category: 'Design',
    role: '포스터 디자인',
    contribution: '포스터 디자인 100%를 담당했습니다.',
